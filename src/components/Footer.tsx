...
export default function Footer() {
    return (
        <footer className="py-12 px-6 bg-primary/50 text-text">
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="flex flex-col w-auto">
                        <h4 className="font-semibold text-l mb-4">Navigation</h4>
                ...
                <div className="pt-8 border-t border-text/20 text-center text-text/50 text-sm">
